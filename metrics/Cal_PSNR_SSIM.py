...
def main():
    ...
    folder_GT = '/home/ubuntu/文档/RSSR/TTST/TTST_datasets/test/DIOR1000/GT/'   # GT 图像路径（不要包含中文）
    folder_test = '/home/ubuntu/文档/RSSR/TTST/BasicRSISR/results/08-59-34/'   # 所要计算的结果路径
    writer = pd.ExcelWriter('TTST_DIOR.xlsx')  # 关键2，创建名称为hhh的excel表格
